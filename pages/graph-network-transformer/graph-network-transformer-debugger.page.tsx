...
const GraphNetworkTransformerDebuggerPage = () => {
  ...
  const handleSolve = () => {
    const newTransformer = new GraphNetworkTransformer({
      initialGraph: JSON.parse(JSON.stringify(initialGraphSimple)), // Use a deep copy
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
      ...
      >
        <div>
          <h2>Initial Graph</h2>
          <InteractiveGraphics
            graphics={getGraphicsForBpcGraph(initialGraphSimple)}
            height={400}
            width={400}
          />
        </div>
        <div>
          <h2>Target Graph</h2>
          <InteractiveGraphics
            graphics={getGraphicsForBpcGraph(targetGraphSimple)}
            height={400}
            width={400}
          />
        </div>
