      ...
      {layoutResult && (
        <div>
          ...
          <div style={{ marginBottom: "30px" }}>
            <h3>Step 1: Graph Partitioning</h3>
            <p>
          ...
          <div style={{ marginBottom: "30px" }}>
            <h3>Step 4: Partition Iteration Process</h3>
            <p>
          ...
          <div style={{ marginBottom: "30px" }}>
            <h3>Step 5: Final Merged Layout</h3>
            <p>
